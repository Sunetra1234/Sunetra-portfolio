...
import WebDev1 from '../assets/download.jpeg';
import VidEdit1 from '../assets/graphic.jpg';
import Prog2 from '../assets/shutterstock_535124956-scaled.jpg';
    ...
    <section className='section' id='skills'>
      <div className='container mx-auto mt-5'>
        <div className='flex flex-col lg:flex-row gap-x-10'>
          <motion.div variants={fadeIn('right',0)} initial='hidden' whileInView='show' viewport={{once:false,amount:0.5}} className='flex-1 flex flex-col gap-y-32 mb-10 lg:mb-0'>
            <div>
            ...
            <div className='group relative overflow-hidden  border-white/50 rounded-lg'>
              ...
              <img className='group-hover:scale-125 transition-all duration-500' src={WebDev1} alt='' height={400} width={400}/>
          ...
          <motion.div variants={fadeIn('left',0)} initial='hidden' whileInView='show' viewport={{once:false,amount:0.5}} className='flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0'>
            <div className='group relative overflow-hidden  border-white/50 rounded-lg'>
              <div className='group-hover:bg-black/70 w-full h-full absolute z-40 transition-all duration-300'></div>
              <img className='group-hover:scale-125 transition-all duration-500' src={Prog2} alt=''  height={400} width={400}/>
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 trasition-all duration-500 z-50'>
            ...
            <div className='group relative overflow-hidden  border-white/50 rounded-lg'>
              <div className='group-hover:bg-black/70 w-full h-full absolute z-40 transition-all duration-300'></div>
              <img className='group-hover:scale-125 transition-all duration-500' src={VidEdit1} alt=''  height={400} width={400}/>
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 trasition-all duration-500 z-50'>
