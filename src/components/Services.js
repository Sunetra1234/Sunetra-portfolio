...
const schools=[
  ...
  {
    insti:'Central Modern School -Kolkata,India',
    course:'ISC XII-Physics,Chemistry,Mathematics and Biology 2020-22',
    link:'Learn More',
    url:'https://www.centralmodernschool.in/',
  },
  {
    insti:'Central Modern School -Kolkata,India',
    course:'ICSE X',
      ...
      <div className="container mx-auto">
        <div className='flex flex-col lg:flex-row'>
          <motion.div variants={fadeIn('right',0.3)} initial='hidden' whileInView='show' viewport={{once:false,amount:0.7}} className='flex-1 bg-services bg-contain items-right lg:bg-bottom bg-no-repeat mix-blend-lighten mb-12 lg:mb-0'>
            <h2 className='h2 text-accent mt-6 mb-6 mx-20'>EDUCATION</h2>
            <h4 className="h4 max-w-[455px] mb-16 mx-20 text-slate-950 font-bold">An investment in knowledge pays the best interest.</h4>
            <a href='https://www.iitkgp.ac.in/'><button className='btn btn-sm mx-20'>See my College</button></a>
          </motion.div>
                ...
                return (
                  <div className='border-b border-white/20 h-[146px] mb-{38px} flex' key={index}>
                    ...
                    <div className='flex flex-col flex-1 items-end'>
                      ...
                      <a href={url} className='text-gradient text-sm mx-20'>
                        {link}
                      </a>
                    </div>
                  </div>
